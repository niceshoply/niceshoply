...
This plugin provides seamless integration between NiceShoply and Stripe payment gateway. It supports both Stripe Elements (on-site payment) and Stripe Checkout (redirect payment) modes, ensuring flexibility for different business needs.
...
2. Extract the contents to your NiceShoply `plugins/Stripe` directory
...
1. Log in to your NiceShoply admin  
...
```json
{
    ...
    "icon": "icon.png",
    "author": {
        "name": "NiceShoply Team",
        "email": "team@niceshoply.com",
        "homepage": "https://www.niceshoply.com"
    }
}
```
...
Configuration fields displayed in the admin  :
...
1. **Monitor Payments**: View all Stripe transactions in the admin  
...
- **Documentation**: [NiceShoply Docs](https://docs.niceshoply.com)
- **Community**: [NiceShoply Forum](https://forum.niceshoply.com)
- **Email**: [team@niceshoply.com](mailto:team@niceshoply.com)
- **GitHub**: [NiceShoply GitHub](https://github.com/NiceShoply)
