...
<head>
  ...
  <title>{{ $plugin->getLocaleName() }} - NiceShoply</title>
  <meta name="keywords" content="@yield('keywords', 'NiceShoply, Innovative, Open Source, Laravel, Multi-language, Multi-currency, Hook, Plugin Architecture, Flexible, Powerful')">
