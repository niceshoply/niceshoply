        ...
        <div class="articles-section" v-loading="loading">
          <template v-if="articleData.length">
            <draggable 
              ...
              :list="articleData" 
              @change="itemChange"
              :animation="330" handle=".drag-handle"
              :item-key="item => articleData.indexOf(item)"
            >
              <template #item="{ element: item, index }">
              <div class="article-item">
                <div class="article-info">
                  <el-tooltip effect="dark" :content="lang.drag_sort" placement="left">
  ...
  Vue.component('module-editor-article', {
    ...
    methods: {
      ...
      loadArticles() {
        ...
        axios.get('api/v1/console/articles/names?ids=' + this.form.articles.map(e => e.id).join(','), {
          headers: {
      ...
      querySearch(keyword, cb) {
        axios.get('api/v1/console/articles/autocomplete?keyword=' + encodeURIComponent(keyword), {
          headers: {
