        ...
        <div class="row-manager">
            ...
            <div class="row-item" v-for="(row, rowIndex) in form.rows" :key="rowIndex">
              <div class="row-header">
                ...
                <div class="row-actions">
                  <el-button text @click="row.collapsed = !row.collapsed" size="small">
                    <el-icon><component :is="row.collapsed ? 'ArrowDown' : 'ArrowUp'" /></el-icon>
                    @{{ row.collapsed ? lang.expand : lang.collapse }}
                  </el-button>
                  <el-button text @click="removeRow(rowIndex)" size="small"><el-icon><Delete /></el-icon></el-button>
                </div>
              </div>
              ...
              <div v-show="!row.collapsed" class="image-list">
                  ...
                  <div class="image-item" v-for="(item, index) in row.images" :key="index">
                    <div class="image-preview">
                      ...
                      <div class="image-actions">
                        <el-button text @click="removeImage(rowIndex, index)" size="small"><el-icon><Delete /></el-icon></el-button>
                      </div>
                    </div>
                ...
                <div class="add-image" v-if="!row.images || row.images.length < row.count">
                  <el-button type="primary" size="small" @click="addImage(rowIndex)">
                    <el-icon><CirclePlus /></el-icon> @{{ lang.add_image_with_count }} (@{{ row.images ? row.images.length : 0 }}/@{{ row.count }})
                  </el-button>
                </div>
              </div>
            </div>
          ...
          <div class="add-row">
            <el-button type="primary" size="small" @click="addRow()">
              <el-icon><CirclePlus /></el-icon> @{{ lang.add_new_row }}
            </el-button>
          </div>
        </div>
      </div>
