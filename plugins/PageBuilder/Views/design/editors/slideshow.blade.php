    ...
    <div class="editor-section">
      ...
      <div class="slideshow-list">
        <draggable
          ...
          :animation="330"
          handle=".drag-handle"
          :item-key="item => module.images.indexOf(item)"
        >
          ...
          <div class="slide-item">
            ...
            <div class="slide-header" @click="toggleSlide(index)">
              ...
              <div class="slide-actions">
                ...
                <el-icon class="toggle-icon"><component :is="item.show ? 'ArrowUp' : 'ArrowDown'" /></el-icon>
              </div>
            </div>
              ...
              <div class="content-section">
                ...
                <div class="setting-group">
                  ...
                  <div style="display: flex; gap: 10px; margin-top: 10px;">
                    ...
                    >
                      <el-icon><Fold /></el-icon> @{{ lang.left }}
                    </el-button>
                    <el-button 
                    ...
                    >
                      <el-icon><Operation /></el-icon> @{{ lang.center }}
                    </el-button>
                    <el-button 
                    ...
                    >
                      <el-icon><Expand /></el-icon> @{{ lang.right }}
                    </el-button>
                  </div>
                </div>
              </div>
        ...
        <div class="add-button-wrapper">
          <el-button type="primary" size="small" @click="addImage">
            <el-icon><Plus /></el-icon> @{{ lang.add_slideshow }}
          </el-button>
        </div>
      </div>
    </div>
