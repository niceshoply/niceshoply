    ...
    <div class="editor-section">
      ...
      <div class="section-content">
        ...
        <draggable ghost-class="dragabble-ghost" :list="form.images"
          :animation="330" handle=".drag-handle" :item-key="item => form.images.indexOf(item)">
          ...
          <div class="image-item">
            <div class="image-header" @click="itemShow(index)">
              ...
              <div class="image-actions">
                ...
                <el-icon><component :is="item.show ? 'ArrowUp' : 'ArrowDown'" /></el-icon>
              </div>
            </div>
        ...
        <div class="add-image-section" v-if="form.images.length < 4">
          <el-button type="primary" size="small" @click="addImage">
            <el-icon><CirclePlus /></el-icon> @{{ lang.add_image }} (@{{ form.images.length }}/4)
          </el-button>
        </div>
      </div>
    </div>
