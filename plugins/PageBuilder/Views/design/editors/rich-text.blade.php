          ...
          <div class="content-editor">
            <div class="editor-preview">
              ...
              <div class="preview-footer">
                ...
                <div class="content-status content-status--set" v-if="form.content[currentLanguage] && form.content[currentLanguage].trim()">
                  <el-icon><Check /></el-icon>
                  <span>@{{ lang.content_set }}</span>
                </div>
                <div class="content-status content-status--unset" v-else>
      ...
      openFloatingEditor() {
          ...
          setup: function(editor) {
            ...
            editor.on("paste", (e) => {
              ...
              for (let i = 0; i < clipboardData.items.length; i++) {
                ...
                axios
                  .post("api/v1/console/file_manager/upload", formData)
                  .then((response) => {
        ...
        saveBtn.onclick = function() {
          if (self.floatingEditor) {
            ...
            saveBtn.innerHTML = '<span class="save-check">✓</span><span>' + lang.content_saved + '</span>';
            
            setTimeout(() => {
              saveBtn.classList.remove('saved');
              saveBtn.innerHTML = '<span class="save-check">✓</span><span>' + lang.save_content + '</span>';
            }, 1200);
          }
        };
