<header class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
  <div class="container-fluid">
    <div class="d-flex align-items-center">
      <a href="{{ console_route('pbuilder.index') }}" class="btn btn-link text-muted p-0 me-3 d-flex align-items-center text-decoration-none">
        <img src="{{ image_origin(system_setting('logo', 'images/logo.png')) }}" alt="NiceShoply" height="28" class="me-2">
    ...
    <div class="navbar-nav d-flex align-items-center">
      ...
      <div class="nav-item">
        <button class="btn btn-primary action-btn" @click="saveButtonClicked" :disabled="saveStatus === 'saving'">
          <el-icon v-if="saveStatus !== 'saving'"><Check /></el-icon>
