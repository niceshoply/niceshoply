...
return [
    ...
    */
    ...
    // File manager driver: local, s3, oss
    'file_manager' => [
    ...
    */
    ...
    'disks' => [
        ...
        // Site-level assets (logos, favicon, etc.) stored in public/
        'site' => [
            'driver'     => 'local',
            'root'       => public_path(),
            'url'        => env('APP_URL'),
        ...
        // Frontend uploads (product reviews, avatars, etc.)
        'upload' => [
            'driver'      => 'local',
        ...
        // Console media manager (file manager local storage)
        'media' => [
            'driver'      => 'local',
