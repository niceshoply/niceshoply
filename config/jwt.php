...
return [
    ...
    */
    ...
    'ttl' => (int) env('JWT_TTL', 60), // Access Token 有效期: 60 分钟
    ...
    */
    ...
    'refresh_ttl' => (int) env('JWT_REFRESH_TTL', 20160), // Refresh Token 窗口: 14 天
    ...
    */
    ...
    'blacklist_grace_period' => (int) env('JWT_BLACKLIST_GRACE_PERIOD', 30), // 并发请求宽限 30 秒
