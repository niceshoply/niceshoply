...
return [
    'no_custom_theme'          => '系统目录下无自定义模板, 使用 niceshoply/front/resources 下默认模板',
    ...
    'theme_deactivated'   => '主题已停用',
    'activate'            => '激活',
    'deactivate'          => '停用',
    'import_demo'         => '导入演示',
    'no_themes'           => '暂无可用主题',
    'confirm_deactivate'  => '确定要停用此主题吗？',
    'confirm_import_demo' => '导入演示数据将覆盖现有数据，是否继续？',
];
