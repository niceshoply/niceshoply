...
return [
    'no_custom_theme' => 'There is no custom template in the system directory, use the default template in niceshoply/front/resources',
    ...
    'theme_deactivated'   => 'Theme deactivated successfully',
    'activate'            => 'Activate',
    ...
    'confirm_import_demo' => 'Importing demo data will overwrite existing data. Continue?',
];
