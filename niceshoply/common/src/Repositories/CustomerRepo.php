...
use NiceShoply\Common\Repositories\Customer\GroupRepo;
...
class CustomerRepo extends BaseRepo
{
    ...
    {
        $criteria = [
            ['name' => 'keyword', 'type' => 'input', 'label' => trans('console/customer.name')],
            ['name' => 'email', 'type' => 'input', 'label' => trans('console/customer.email')],
            ['name'       => 'customer_group_id', 'label' => trans('console/customer.group'), 'type' => 'select',
                'options' => GroupRepo::getInstance()->getSimpleList(), 'options_key' => 'id', 'options_label' => 'name',
            ],
            ['name' => 'from', 'type' => 'select', 'label' => trans('console/customer.from'), 'options' => self::getFromList(), 'options_key' => 'key', 'options_label' => 'value'],
            ['name' => 'locale', 'type' => 'input', 'label' => trans('console/customer.locale')],
