...
class StateRepo extends BaseRepo
{
    ...
    {
        return [
            ['name' => 'name', 'type' => 'input', 'label' => trans('console/state.name')],
            ['name' => 'code', 'type' => 'input', 'label' => trans('console/state.code')],
            ['name' => 'country_code', 'type' => 'input', 'label' => trans('console/state.country_code')],
        ];
    }
