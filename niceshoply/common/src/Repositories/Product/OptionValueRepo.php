...
namespace NiceShoply\Common\Repositories\Product;

use Exception;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Collection;
use NiceShoply\Common\Models\Product\OptionValue;
...
class OptionValueRepo extends BaseRepo
{
    ...
    public function createProductOptionValues(int $productId, $optionValues): bool
    {
        ...
        \NiceShoply\Common\Models\Product\Option::where('product_id', $productId)->delete();
        ...
        foreach ($optionValues as $optionConfig) {
            ...
            \NiceShoply\Common\Models\Product\Option::create([
