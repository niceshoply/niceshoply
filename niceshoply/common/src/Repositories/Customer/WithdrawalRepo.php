...
class WithdrawalRepo extends BaseRepo
{
    ...
    public static function getCriteria(): array
    {
        ...
        return [
            ['name' => 'customer_id', 'type' => 'input', 'label' => trans('console/withdrawal.customer_id')],
            ['name' => 'status', 'type' => 'select', 'label' => trans('console/withdrawal.status'), 'options' => $statusOptions, 'options_key' => 'code', 'options_label' => 'label'],
            ['name' => 'account_type', 'type' => 'select', 'label' => trans('console/withdrawal.account_type'), 'options' => $accountTypeOptions, 'options_key' => 'code', 'options_label' => 'label'],
            ['name' => 'amount', 'type' => 'range', 'label' => trans('console/withdrawal.amount')],
    ...
    private function createWithdrawTransaction(Withdrawal $withdrawal): void
    {
        ...
        \NiceShoply\Common\Repositories\Customer\TransactionRepo::getInstance()->create($transactionData);
    }
}
