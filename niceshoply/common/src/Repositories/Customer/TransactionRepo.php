...
class TransactionRepo extends BaseRepo
{
    ...
    public static function getCriteria(): array
    {
        ...
        return [
            ['name' => 'customer_id', 'type' => 'input', 'label' => trans('console/transaction.customer')],
            ['name' => 'email', 'type' => 'input', 'label' => trans('console/common.email')],
            ['name' => 'type', 'type' => 'select', 'label' => trans('console/transaction.type'), 'options' => $options, 'options_key' => 'code', 'options_label' => 'label'],
            ['name' => 'amount', 'type' => 'range', 'label' => trans('console/transaction.amount')],
