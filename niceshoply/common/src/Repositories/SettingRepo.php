...
{
    public const CACHE_KEY = 'grouped_settings';
    ...
    public function groupedSettings(): array
    {
        return Cache::remember(self::CACHE_KEY, self::CACHE_TTL, function () {
            return $this->loadGroupedSettings();
        });
    }
     ...
     */
    private function loadGroupedSettings(): array
    {
    ...
    private function checkDefaultCurrencyRate($name, $value, $space): void
    {
        ...
        if ($currency->value != 1) {
            throw new Exception(trans('console/currency.default_currency_rate'));
        }
    }
