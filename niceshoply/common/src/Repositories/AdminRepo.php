...
class AdminRepo extends BaseRepo
{
    ...
    {
        return [
            ['name' => 'name', 'type' => 'input', 'label' => trans('console/admin.name')],
            ['name' => 'email', 'type' => 'input', 'label' => trans('console/admin.email')],
            ['name' => 'locale', 'type' => 'input', 'label' => trans('console/admin.locale')],
        ];
    }
