...
class ArticleRepo extends BaseRepo
{
    ...
    {
        return [
            ['name' => 'title', 'type' => 'input', 'label' => trans('console/article.title')],
            ['name' => 'catalog', 'type' => 'input', 'label' => trans('console/article.catalog')],
            ['name' => 'slug', 'type' => 'input', 'label' => trans('console/common.slug')],
        ];
    }
