 ...
 *
 * This command requires NiceShoply version >= 0.4.0
 */
class NormalizeLocales extends Command
{
    ...
    public function handle(): void
    {
        ...
        $currentVersion = config('niceshoply.version');
        if (version_compare($currentVersion, '0.4.0', '<')) {
            $this->error('This command requires NiceShoply version 0.4.0 or higher.');
