...
use NiceShoply\Common\Models\Product\Option as ProductOption;
        ...
        foreach ($optionGroups as $group) {
            ...
            if (isset($selectedOptions[$group->id])) {
                ...
                foreach ($selectedOptionIds as $optionId) {
                    ...
                    // 检查选项值库存
                    $productOptionValue = \NiceShoply\Common\Models\Product\OptionValue::where('product_id', $this->product->id)
