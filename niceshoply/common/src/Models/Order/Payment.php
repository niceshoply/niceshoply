...
class Payment extends BaseModel
{
    ...
    {
        return $this->paid ? trans('console/order.paid') : trans('console/order.unpaid');
    }
    ...
    {
        return $this->paid ? trans('console/order.payment_success') : trans('console/order.payment_pending');
    }
}
