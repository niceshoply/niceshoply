...
use NiceShoply\Common\Models\Customer\Social;
use NiceShoply\Common\Models\Customer\Transaction;
use NiceShoply\Common\Notifications\ForgottenNotification;
use NiceShoply\Common\Notifications\RegistrationNotification;
use PHPOpenSourceSaver\JWTAuth\Contracts\JWTSubject;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;
use Throwable;

class Customer extends AuthUser implements JWTSubject
{
    ...
    protected $fillable = [
        'email', 'password', 'name', 'avatar', 'customer_group_id', 'member_level_id', 'address_id', 'locale', 'active', 'code', 'from',
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['email', 'name', 'active', 'customer_group_id', 'locale'])
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs()
