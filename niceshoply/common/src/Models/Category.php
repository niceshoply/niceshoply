...
{
    use HasPackageFactory, LogsActivity, Translatable;
    ...
    protected static function booted(): void
    {
        ...
        static::saved(fn () => TreeRepo::clearCache());
        static::deleted(fn () => TreeRepo::clearCache());
    }
    ...
    {
        return console_route('categories.edit', $this);
    }
