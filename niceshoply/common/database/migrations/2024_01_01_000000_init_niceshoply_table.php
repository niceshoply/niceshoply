...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('addresses', function (Blueprint $table) {
            ...
            $table->unsignedInteger('customer_id')->index('addr_customer_id')->comment('Customer ID');
            ...
            $table->unsignedInteger('country_id')->index('addr_country_id')->comment('Country ID');
            $table->unsignedInteger('state_id')->index('addr_state_id')->comment('state ID');
            $table->string('state')->comment('state Name');
            $table->unsignedInteger('city_id')->nullable()->index('addr_city_id')->comment('City ID');
        ...
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->string('image')->nullable()->comment('Article Main Image');
            $table->boolean('active')->default(true)->comment('Active');
            $table->timestamps();
        });
        ...
        Schema::create('attribute_value_translations', function (Blueprint $table) {
            ...
            $table->bigIncrements('id');
            $table->unsignedInteger('attribute_value_id')->index('avt_attribute_value_id')->comment('Attribute Value ID');
            $table->string('locale')->default('')->comment('Locale Code');
            $table->string('name')->default('')->comment('Name');
            $table->timestamps();
        ...
        Schema::create('attribute_values', function (Blueprint $table) {
            ...
            $table->bigIncrements('id');
            $table->unsignedInteger('attribute_id')->index('av_attribute_id')->comment('Attribute ID');
            $table->timestamps();
        });
        ...
        Schema::create('attributes', function (Blueprint $table) {
            ...
            $table->unsignedInteger('attribute_group_id')->index('attr_attribute_group_id')->comment('Attribute Group ID');
            $table->integer('position')->default(0)->comment('Sort order');
            $table->timestamps();
        });
        ...
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('ID');
            $table->unsignedBigInteger('parent_id')->default(0)->index('cat_parent_id')->comment('Parent Category ID');
            $table->string('slug', 128)->nullable()->unique()->comment('URL Slug');
        ...
        Schema::create('category_translations', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('ID');
            $table->unsignedBigInteger('category_id')->index('catt_category_id')->comment('Category ID');
            $table->string('locale')->comment('Locale Code');
            $table->string('name')->comment('Name');
            $table->text('summary')->nullable()->comment('Category Summary');
            $table->longText('content')->nullable()->comment('Content');
        ...
        Schema::create('customer_group_translations', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('ID');
            $table->unsignedInteger('customer_group_id')->index('cgt_customer_group_id')->comment('Customer Group ID');
        ...
        Schema::create('customers', function (Blueprint $table) {
            ...
            $table->string('calling_code', 10)->nullable()->comment('Calling Code (e.g., +86, +1)');
            $table->string('telephone', 20)->nullable()->comment('Telephone Number');
            $table->string('password')->comment('Password');
            $table->string('name')->comment('Name');
            $table->decimal('balance')->default(0)->comment('Customer Balance');
            ...
            $table->index(['calling_code', 'telephone'], 'cust_calling_telephone');
        });

        Schema::create('customer_transactions', function (Blueprint $table) {
            $table->comment('Customer Transaction');
            $table->id();
        ...
        Schema::create('customer_withdrawals', function (Blueprint $table) {
            $table->comment('Customer Withdrawal');
            $table->id();
            $table->integer('customer_id')->index('cwd_customer_id');
            ...
            $table->index(['customer_id', 'status'], 'cwd_customer_status');
            $table->index(['status', 'created_at'], 'cwd_status_created');
        });
        ...
        Schema::create('model_has_permissions', function (Blueprint $table) {
            ...
            $table->index(['model_id', 'model_type'], 'mhp_model_id_type');
        ...
        Schema::create('model_has_roles', function (Blueprint $table) {
            ...
            $table->index(['model_id', 'model_type'], 'mhr_model_id_type');
        ...
        Schema::create('notifications', function (Blueprint $table) {
            ...
            $table->index(['notifiable_type', 'notifiable_id'], 'notif_notifiable');
        });
        ...
        Schema::create('pages', function (Blueprint $table) {
            ...
            $table->integer('position')->default(0)->comment('Sort order');
            $table->integer('viewed')->default(0)->comment('Viewed');
            $table->boolean('show_breadcrumb')->default(true)->comment('show breadcrumb');
            $table->boolean('active')->default(true)->comment('Active');
            $table->timestamps();
        });
        ...
        Schema::create('permissions', function (Blueprint $table) {
            ...
            $table->unique(['name', 'guard_name'], 'perm_name_guard');
        });
        ...
        Schema::create('product_images', function (Blueprint $table) {
            ...
            $table->boolean('is_cover')->default(false)->comment('Is Cover');
            $table->boolean('belong_sku')->default(false)->comment('Belong to SKU');
            $table->integer('position')->default(0)->comment('Sort Order');
            $table->timestamps();
        });
        ...
        Schema::create('product_skus', function (Blueprint $table) {
            ...
            $table->json('images')->nullable()->comment('SKU Images');
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('ID');
            $table->unsignedInteger('brand_id')->index('prod_brand_id')->comment('Brand ID');
            $table->json('images')->nullable()->comment('Product Images');
            $table->string('hover_image')->nullable()->comment('Product hover image');
            $table->json('video')->nullable()->comment('Product Video');
            $table->decimal('price')->default(0)->comment('Product Price');
            $table->string('type')->default('normal')->comment('Product Type');
        ...
        Schema::create('roles', function (Blueprint $table) {
            ...
            $table->unique(['name', 'guard_name'], 'role_name_guard');
        });
        ...
        Schema::create('tax_rates', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('ID');
            $table->integer('region_id')->index('tr_region_id')->comment('Region ID');
        ...
        Schema::create('verify_codes', function (Blueprint $table) {
            ...
            $table->string('code', 16)->comment('Code');
            $table->string('type', 20)->default('register')->comment('Verification Type: register, login, reset');
            $table->softDeletes()->comment('Deleted At');
            $table->timestamps();
        });

        Schema::create('weight_classes', function (Blueprint $table) {
            $table->comment('Weight Class');
            $table->id()->comment('ID');
        ...
        Schema::create('option_values', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('Primary key');
            $table->unsignedBigInteger('option_id')->index('ov_option_id')->comment('Option ID reference');
        ...
        Schema::create('product_options', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('Primary key');
            $table->unsignedBigInteger('product_id')->index('po_product_id')->comment('Product ID reference');
            $table->unsignedBigInteger('option_id')->index('po_option_id')->comment('Option ID reference');
            $table->integer('position')->default(0)->comment('Display position');
            $table->timestamps();

            $table->unique(['product_id', 'option_id'], 'po_product_option_unique');
        });

        Schema::create('product_option_values', function (Blueprint $table) {
            $table->comment('Product option values with pricing and inventory configuration');
            $table->bigIncrements('id')->comment('Primary key');
            $table->unsignedBigInteger('product_id')->index('pov_product_id')->comment('Product ID reference');
            $table->unsignedBigInteger('option_id')->index('pov_option_id')->comment('Option ID reference');
            $table->unsignedBigInteger('option_value_id')->index('pov_option_value_id')->comment('Option value ID reference');
        ...
        Schema::create('cart_option_values', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('Primary key');
            $table->unsignedBigInteger('cart_item_id')->index('cov_cart_item_id')->comment('Cart item ID reference');
            $table->unsignedBigInteger('option_id')->index('cov_option_id')->comment('Option ID reference');
            $table->unsignedBigInteger('option_value_id')->index('cov_option_value_id')->comment('Option value ID reference');
        ...
        Schema::create('order_option_values', function (Blueprint $table) {
            ...
            $table->bigIncrements('id')->comment('Primary key');
            $table->unsignedBigInteger('order_item_id')->index('oov_order_item_id')->comment('Order item ID reference');
            $table->unsignedBigInteger('option_id')->index('oov_option_id')->comment('Option ID reference');
            $table->unsignedBigInteger('option_value_id')->index('oov_option_value_id')->comment('Option value ID reference');
        ...
        Schema::table('role_has_permissions', function (Blueprint $table) {
            ...
            $table->foreign(['role_id'], 'rhp_role_fk')->references(['id'])->on('roles')->onUpdate('restrict')->onDelete('cascade');
        });
    }
