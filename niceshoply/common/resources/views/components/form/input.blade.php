<x-console::form.row :title="$title" :required="$required" :disabled="$disabled" :readonly="$readonly" :locale-code="$localeCode ?? ''" :column="$column" :generate="$generate" :translate="$translate">
  @if (!$multiple)
