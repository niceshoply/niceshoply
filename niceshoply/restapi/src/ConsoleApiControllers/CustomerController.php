...
use NiceShoply\Common\Resources\CustomerSimple;
...
class CustomerController extends BaseController
{
    ...
    public function store(CustomerRequest $request): mixed
    {
        try {
            ...
            return json_success(console_trans('common.updated_success'), $customer);
        } catch (Exception $e) {
     ...
     * /api/console/customers/autocomplete?keyword=xxx
     *
     * @param  Request  $request
     * @return AnonymousResourceCollection
     * @throws Exception
