...
namespace NiceShoply\Install\Libraries;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Str;
use NiceShoply\Install\Libraries\Database\MySQLDatabase;
use NiceShoply\Install\Libraries\Database\SQLiteDatabase;
use NiceShoply\Install\Libraries\Environment\EnvironmentChecker;

/**
 * Installer class
 *
 * Handles the installation process of NiceShoply
 */
class Installer
{
    ...
    {
        $env = [
            'APP_NAME'  => $data['app_name'] ?? 'NiceShoply',
            'APP_ENV'   => 'production',
