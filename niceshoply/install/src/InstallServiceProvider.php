...
namespace NiceShoply\Install;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use NiceShoply\Install\Middleware\PreventReinstall;
...
class InstallServiceProvider extends ServiceProvider
{
    ...
    {
        Route::name('install.')
            ->middleware([PreventReinstall::class])
            ->group(function () {
    ...
    {
        $originViewPath = nice_path('install/resources/views');
