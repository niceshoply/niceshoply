# NiceShoply Installer Tests

This directory contains test cases for the NiceShoply installer.
...
```bash
php artisan test niceshoply/install/tests
```

### Run Specific Test File

```bash
php artisan test niceshoply/install/tests/InstallerTest.php
```

### Run Specific Test Method

```bash
php artisan test --filter test_can_install_with_my_sql niceshoply/install/tests/InstallerTest.php
```
