...
namespace NiceShoply\Plugin\Core;
...
final class Plugin implements Arrayable, ArrayAccess
{
    ...
    {
        return trans("console/plugin.{$this->type}");
    }
    ...
    public function getEditUrl(): string
    {
        try {
            ...
            return '/'.$consolePath.'/plugin-edit/'.$this->code;
        } catch (Exception $e) {
            return '';
        }
    }
    ...
    protected function findPluginRoutes(): array
    {
        ...
        $sidebarHooks = [
            'console.component.sidebar.product.routes',
            'console.component.sidebar.order.routes',
            'console.component.sidebar.customer.routes',
            'console.component.sidebar.content.routes',
            'console.component.sidebar.design.routes',
            'console.component.sidebar.analytic.routes',
            'console.component.sidebar.marketing.routes',
            'console.component.sidebar.setting.routes',
            'console.component.sidebar.plugin.routes',
        ];
    ...
    {
        $viewFile = $this->getPath().'/Views/console/config.blade.php';
        if (file_exists($viewFile)) {
            return "{$this->dirName}::console.config";
        }
    ...
    /**
     * 判断插件是否包含数据填充器（Seeders）。
     *
     * 注意：NiceShoply 插件采用顶层目录约定（与 Migrations 平级），
     * 即 {plugin}/Seeders，而非上游的 {plugin}/Database/Seeders。
     *
     * @return bool
     */
