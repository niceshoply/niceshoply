...
use NiceShoply\Common\Repositories\SettingRepo as CommonSettingRepo;
use NiceShoply\Plugin\Models\Setting;
...
class SettingRepo extends CommonSettingRepo
{
    ...
    public function getPluginActiveField(): array
    {
        return [
            'name'     => 'active',
            'label'    => console_trans('common.status'),
            'type'     => 'bool',
            'required' => true,
        ];
    }
    ...
    public function getPluginAvailableField(): array
    {
        return [
            'name'    => 'available',
            'label'   => console_trans('common.available'),
            'type'    => 'checkbox',
            'options' => [
