...
class ThemeMarketController
{
    ...
    public function index(Request $request): mixed
    {
        try {
            ...
            return nice_view('plugin::theme_market.index', $data);
        } catch (\Exception $e) {
            return nice_view('plugin::theme_market.index', [
                'categories' => ['data' => []],
                'products'   => ['data' => []],
                'error'      => $e->getMessage(),
    ...
    public function show(int $slug): mixed
    {
        try {
            ...
            return nice_view('plugin::theme_market.detail', $data);
        } catch (\Exception $e) {
            return nice_view('plugin::theme_market.detail', [
                'categories' => ['data' => []],
                'product'    => null,
                'error'      => $e->getMessage(),
            ])->with('error', $e->getMessage());
