...
use NiceShoply\Console\Requests\OptionRequest;
...
class OptionController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return nice_view('console::options.index', $data);
    }
        ...
        try {
            ...
            if ($request->ajax()) {
                return response()->json([
                    'success' => true,
                    'message' => console_trans('common.created_success'),
                    'data'    => $option,
                ]);
            }

            return redirect(console_route('options.index'))
    ...
    public function update(OptionRequest $request, Option $option): RedirectResponse|JsonResponse
    {
        try {
            ...
            if ($request->ajax()) {
                return response()->json([
                    'success' => true,
                    'message' => console_trans('common.updated_success'),
                    'data'    => $option,
                ]);
            }
