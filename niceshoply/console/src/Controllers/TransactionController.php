...
use NiceShoply\Console\Requests\TransactionRequest;
use Throwable;
...
class TransactionController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return nice_view('console::transactions.index', $data);
    }
    ...
    public function store(TransactionRequest $request): RedirectResponse
    {
        try {
            ...
            return redirect(console_route('transactions.index'))
    ...
    public function form(Transaction $transaction): mixed
    {
        ...
        return nice_view('console::transactions.form', $data);
    }
    ...
    public function show(Transaction $transaction): mixed
    {
        ...
        return nice_view('console::transactions.show', $data);
    }
