...
class ArticleRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        ...
        return [
            'catalog_id' => trans('console/article.catalog'),

            "translations.$defaultLocale.locale"  => trans('console/article.locale'),
            "translations.$defaultLocale.title"   => trans('console/article.title'),
            "translations.$defaultLocale.content" => trans('console/article.content'),

            'translations.*.summary'          => trans('console/article.summary'),
            'translations.*.meta_title'       => trans('console/common.meta_title'),
            'translations.*.meta_keywords'    => trans('console/common.meta_keywords'),
            'translations.*.meta_description' => trans('console/common.meta_description'),
        ];
    }
}
