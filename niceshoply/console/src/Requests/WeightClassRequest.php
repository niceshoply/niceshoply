...
class WeightClassRequest extends FormRequest
{
    ...
    {
        return [
            'name'     => console_trans('weight_class.name'),
            'code'     => console_trans('weight_class.code'),
            'unit'     => console_trans('weight_class.unit'),
            'value'    => console_trans('weight_class.value'),
            'position' => console_trans('weight_class.position'),
            'active'   => console_trans('weight_class.active'),
        ];
    }
}
