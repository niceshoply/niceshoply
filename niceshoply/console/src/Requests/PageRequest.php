...
class PageRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        ...
        return [
            "translations.$defaultLocale.locale"  => trans('console/page.locale'),
            "translations.$defaultLocale.title"   => trans('console/page.title'),
            "translations.$defaultLocale.content" => trans('console/page.content'),
