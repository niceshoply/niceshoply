...
class ProductRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        ...
        return [
            'slug'   => console_trans('common.slug'),
            'type'   => console_trans('product.type'),
            'weight' => console_trans('product.weight'),

            "translations.$defaultLocale.locale"  => trans('console/product.locale'),
            "translations.$defaultLocale.name"    => trans('console/product.name'),
            "translations.$defaultLocale.content" => trans('console/product.content'),

            "translations.$defaultLocale.meta_title"       => trans('console/common.meta_title'),
            "translations.$defaultLocale.meta_description" => trans('console/common.meta_description'),
            "translations.$defaultLocale.meta_keywords"    => trans('console/common.meta_keywords'),

            'skus.*.code'  => console_trans('product.sku_code'),
            'skus.*.model' => console_trans('product.model'),

            'bundles'            => console_trans('product.bundles'),
            'bundles.*.sku_id'   => console_trans('product.bundle_sku'),
            'bundles.*.quantity' => console_trans('product.bundle_quantity'),
        ];
    }
}
