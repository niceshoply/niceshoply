export default {
  /**
   * Get console base URL safely
   * @returns {string} Console base URL
   */
  getConsoleBaseUrl() {
    if (typeof urls !== 'undefined' && urls.console_base) {
      return urls.console_base;
    }
  ...
  /**
   * Initialize translation functionality for the admin console
   * Handles text translation, HTML content translation, and individual field translation
   */
  getTranslate() {
    const self = this;
    const getConsoleBaseUrl = () => self.getConsoleBaseUrl();
    ...
    $("#translate-button").click(function () {
      ...
      axios
        .post(`${getConsoleBaseUrl()}/translations/translate-text`, {
    ...
    $("#translate-html").click(function () {
      ...
      axios
        .post(`${getConsoleBaseUrl()}/translations/translate-html`, {
  ...
  imgUploadAjax(file, _self, callback = null) {
    ...
    axios
      .post(urls.console_upload, formData, {})
      .then(function (res) {
        callback(res);
      })
      .catch(function (err) {
