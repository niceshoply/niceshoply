<div class="tab-pane fade mt-3" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
  <x-common-form-input title="{{ __('console/common.slug') }}" name="slug" :value="old('slug', $category->slug ?? '')"
    placeholder="{{ __('console/common.slug') }}" column="category_slug" :generate="true"
      ...
      <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
        ...
        <div class="mb-3 locale-code" data-locale-code={{ $localeCode }}>
          ...
          <x-common-form-input title="{{ __('console/common.meta_title') }}"
            ...
            description="{{ __('console/common.meta_title_description') }}"
          ...
          <x-common-form-textarea title="{{ __('console/common.meta_description') }}"
            ...
            description="{{ __('console/common.meta_description_description') }}"
            :locale-code="$localeCode" />
          ...
          <x-common-form-textarea title="{{ __('console/common.meta_keywords') }}"
            ...
            description="{{ __('console/common.meta_keywords_description') }}"
            :locale-code="$localeCode" />

          <x-common-form-input title="{{ __('console/common.canonical') }}"
            name="translations[{{ $localeCode }}][canonical]"
            value="{{ old('translations.' . $localeCode . '.canonical', $category->translate($localeCode, 'canonical')) }}"
