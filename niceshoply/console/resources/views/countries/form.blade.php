...
@section('title', __('console/menu.country'))

@section('content')
<div class="card h-min-600">
  <div class="card-header">
    <h5 class="card-title mb-0">{{ __('console/menu.countries') }}</h5>
  </div>
  <div class="card-body">
    <form class="needs-validation mt-3" novalidate action="{{ $country->id ? console_route('countries.update', [$country->id]) : console_route('countries.store') }}" method="POST">
      @csrf
