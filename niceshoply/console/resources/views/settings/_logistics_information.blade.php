      ...
      <div class="ml-4" id="logistics-form">
        <div class="row col-7">
          <table class="table table-response align-middle table-bordered">
            <thead>
              <tr>
                <th>{{ __('console/setting.express_company') }}</th>
                <th>{{ __('console/setting.express_code') }}</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(item,index) in text" :key="index">
                <td data-title="State" class="col-5">
                  <el-input v-model="item.company" placeholder="{{ __('console/setting.express_company') }}" />
                </td>
                <td data-title="Remark" class="col-5">
                  <el-input v-model="item.code" placeholder="{{ __('console/setting.express_code_hint') }}" />
                </td>
