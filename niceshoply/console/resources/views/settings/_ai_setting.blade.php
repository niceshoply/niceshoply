    ...
    <div class="tab-content" id="aiSettingsTabContent">
      ...
      <div class="tab-pane fade show active" id="ai-models" role="tabpanel" aria-labelledby="ai-models-tab">
        ...
        <!-- API Configuration Section -->
            <div class="row mt-4">
              <div class="col-12">
                <h5 class="mb-3">{{ __('console/setting.api_configuration') }}</h5>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.openai_description') }} <a href="https://platform.openai.com/api-keys" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.openai_api_key') }}" 
                                         name="openai_api_key" 
                                         value="{{ old('openai_api_key', system_setting('openai_api_key')) }}"
                                         placeholder="sk-..." />
                    </div>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.openai_proxy_url') }}" 
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.deepseek_description') }} <a href="https://platform.deepseek.com/api-keys" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.deepseek_api_key') }}" 
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.kimi_description') }} <a href="https://platform.moonshot.cn/console/api-keys" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.kimi_api_key') }}" 
                                         name="kimi_api_key" 
                ...
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title mb-0">{{ __('console/setting.doubao_title') }}</h6>
                    <x-common-form-model-switch name="doubao_enabled" 
                                               :value="old('doubao_enabled', system_setting('doubao_enabled', false))" 
                                               id="doubao_enabled" />
                  </div>
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.doubao_description') }} <a href="https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.doubao_api_key') }}" 
                                         name="doubao_api_key" 
                ...
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title mb-0">{{ __('console/setting.qianwen_title') }}</h6>
                    <x-common-form-model-switch name="qianwen_enabled" 
                                               :value="old('qianwen_enabled', system_setting('qianwen_enabled', false))" 
                                               id="qianwen_enabled" />
                  </div>
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.qianwen_description') }} <a href="https://bailian.console.aliyun.com/?apiKey=1#/api-key" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.qianwen_api_key') }}" 
                ...
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title mb-0">{{ __('console/setting.hunyuan_title') }}</h6>
                    <x-common-form-model-switch name="hunyuan_enabled" 
                                               :value="old('hunyuan_enabled', system_setting('hunyuan_enabled', false))" 
                                               id="hunyuan_enabled" />
                  </div>
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.hunyuan_description') }} <a href="https://console.cloud.tencent.com/cam/capi" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.hunyuan_api_key') }}" 
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('console/setting.anthropic_description') }} <a href="https://console.anthropic.com/settings/keys" target="_blank">{{ __('console/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('console/setting.anthropic_api_key') }}" 
      ...
      <div class="tab-pane fade" id="ai-content" role="tabpanel" aria-labelledby="ai-content-tab">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">{{ __('console/setting.content_generation_settings') }}</h5>
              </div>
              <div class="card-body">
        ...
        <div class="row mt-4">
          <div class="col-lg-6">
            <x-common-form-select title="{{ __('console/setting.content_quality') }}" name="ai_content_quality"
                                :options="[
                                  ['value' => 'low', 'label' => __('console/setting.quality_low')],
                                  ['value' => 'medium', 'label' => __('console/setting.quality_medium')],
                                  ['value' => 'high', 'label' => __('console/setting.quality_high')]
                                ]" key="value" label="label" :emptyOption="false"
                                value="{{ old('ai_content_quality', system_setting('ai_content_quality', 'medium')) }}" />
          </div>
          <div class="col-lg-6">
            <x-common-form-input title="{{ __('console/setting.max_tokens') }}" 
