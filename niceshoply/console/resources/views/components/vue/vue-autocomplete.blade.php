  ...
  const VueAutocomplete = {
    ...
    setup(props, { emit }) {
      ...
      const querySearchAsync = async (query, cb) => {
        const urlMap = {
          product: urls.console_api + '/products/autocomplete?keyword=',
          category: urls.console_api + '/categories/autocomplete?keyword=',
          brand: urls.console_api + '/brands/autocomplete?keyword=',
          page: urls.console_api + '/pages/autocomplete?keyword='
        };
