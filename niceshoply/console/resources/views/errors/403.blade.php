    ...
    <div class="row align-items-center justify-content-center" style="min-height: calc(100vh - 200px);">
      <div class="col-md-6 text-center">
        <div class="mb-4">
          ...
          <h2 class="h4 mb-3 mt-4">{{ __('console/error.403_title') }}</h2>
          <p class="text-secondary mb-4">{{ __('console/error.403_description') }}</p>
        </div>
        <div class="d-flex gap-3 justify-content-center">
          <a href="javascript:;" onclick="history.back();" class="btn btn-outline-secondary">
            <i class="bi bi-arrow-left me-1"></i> {{ __('console/error.403_back') }}
          </a>
          <a href="{{ console_route('home.index') }}" class="btn btn-primary">
            <i class="bi bi-house me-1"></i> {{ __('console/error.403_home') }}
          </a>
        </div>
      </div>
    </div>
