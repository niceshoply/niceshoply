...
<div class="card h-min-600">
  <div class="card-header">
    <h5 class="card-title mb-0">{{ __('console/menu.tax_rates') }}</h5>
  </div>
  <div class="card-body">
    <form class="needs-validation" novalidate id="app-form"
      action="{{ $tax_rate->id ? console_route('tax_rates.update', [$tax_rate->id]) : console_route('tax_rates.store') }}"
      method="POST">
      @csrf
      ...
      <div class="wp-500 m-auto">
        ...
        <x-console::form.row title="税率" required>
