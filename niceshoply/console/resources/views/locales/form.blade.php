...
@section('title', __('console/menu.locale'))

@section('content')
<div class="card h-min-600">
  <div class="card-header">
    <h5 class="card-title mb-0">{{ __('console/menu.locale') }}</h5>
  </div>
  <div class="card-body">
    <form class="needs-validation mt-3" novalidate action="{{ $locale->id ? console_route('locales.update', [$locale->id]) : console_route('locales.store') }}" method="POST">
      @csrf
