...
<head>
  ...
  <script>
    ...
    function searchProducts() {
      ...
      $.get('/api/v1/products/skus', { keyword }, function(res) {
    ...
    $(function() {
      ...
      $('#confirmBtn').on('click', function() {
        ...
        if (selectedProducts.length === 0) {
          layer.msg('{{ __('console/product.select_product') }}', {icon: 2}); 
          return;
        }
  ...
  <div class="p-4" style="overflow-y: auto;">
    ...
    <div class="card-body">
      <div class="input-group mb-3">
        <input type="text" id="searchInput" class="form-control" placeholder="{{ __('console/product.search_placeholder') }}">   
        <button class="btn btn-primary" id="searchBtn">{{ __('console/common.search') }} </button> 
      </div>
