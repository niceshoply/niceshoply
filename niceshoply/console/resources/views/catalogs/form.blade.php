...
@section('content')
  <form class="needs-validation" novalidate id="app-form"
    action="{{ $catalog->id ? console_route('catalogs.update', [$catalog->id]) : console_route('catalogs.store') }}"
    method="POST">
    @csrf
                ...
                <div class="accordion-item">
                  ...
                  <div id="data-locale-{{ $localeCode }}"
                    ...
                    <div class="accordion-body">
                      ...
                      <x-common-form-input title="{{ __('console/article.title') }}"
                      ...
                      <x-common-form-input title="{{ __('console/common.summary') }}"
                      ...
                      <x-common-form-input title="{{ __('console/setting.meta_title') }}"
                      ...
                      <x-common-form-input title="{{ __('console/setting.meta_keywords') }}"
                      ...
                      <x-common-form-input title="{{ __('console/setting.meta_description') }}"
      ...
      <div class="col-12 col-md-3 ps-md-0">
        <div class="card">
          <div class="card-body">
            ...
            <x-common-form-select title="{{ __('console/catalog.parent') }}" name="parent_id" :value="old('parent_id', $catalog->parent_id ?? 0)"
              :options="$catalogs" key="id" label="name" :emptyOption=false />
            <x-common-form-input title="{{ __('console/common.slug') }}" name="slug" :value="old('slug', $catalog->slug ?? '')"
              placeholder="{{ __('console/common.slug') }}" />
            <x-common-form-input title="{{ __('console/common.position') }}" name="position" :value="old('position', $catalog->position ?? 0)" />
          </div>
        </div>
      </div>
    </div>
