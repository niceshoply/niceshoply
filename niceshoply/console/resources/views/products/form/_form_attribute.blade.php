<div class="card variants-box mb-3" id="attributes-box">
  <div class="card-header">
    <h5 class="card-title mb-0">{{ __('console/attribute.attribute') }}</h5>
  </div>
  
  <div class="card-body" v-if="showAttribute">
    <table class="table table-condensed table-bordered">
      <tr>
        <td>{{ __('console/attribute.attribute') }}</td>
        <td>{{ __('console/attribute.attribute_value') }}</td>
  ...
  <div v-else class="cursor-pointer m-3 text-primary" @click="showAttribute = true">
    <i class="bi bi-plus-square me-1"></i> {{ __('console/attribute.set_attribute') }}
  </div>
