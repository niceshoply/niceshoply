<div class="tab-pane fade mt-4" id="translation-tab-pane" role="tabpanel"
  ...
  <div class="mb-1 fs-6">{{ __('console/product.content') }}</div>
  @if(has_translator())
    <div
      ...
      <div class="me-3">{{ __('console/product.auto_translate') }}</div>
      ...
      <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
        ...
        <div class="mb-3">
          ...
          <x-common-form-rich-text name="translations[{{ $localeCode }}][content]"
                                   ...
                                   required placeholder="{{ __('console/product.describe') }}"
