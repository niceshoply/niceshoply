...
class PaymentService
{
     ...
     * Pay for API.
     *
     * @param  array<string, mixed>  $context  payment_channel: auto|native|h5；client_platform: ios|android
     * @return array
     * @throws Exception
     */
    public function apiPay(array $context = []): array
    {
        $order = $this->order;
        ...
        $paymentData      = [
            ...
            'params'            => null,
            'payment_channel'   => $context['payment_channel'] ?? 'auto',
