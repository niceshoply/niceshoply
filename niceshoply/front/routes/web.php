...
use NiceShoply\Front\Controllers;
use NiceShoply\Front\Controllers\Account;

Route::get('/', [Controllers\HomeController::class, 'index'])->name('home.index');
Route::get('/maintenance', [Controllers\MaintenanceController::class, 'index'])->name('maintenance.index');

// 法律文档
Route::get('/privacy-policy', [Controllers\LegalController::class, 'privacy'])->name('legal.privacy');
Route::get('/terms-of-service', [Controllers\LegalController::class, 'terms'])->name('legal.terms');
Route::get('/cookie-policy', [Controllers\LegalController::class, 'cookie'])->name('legal.cookie');
Route::get('/open-source-license', [Controllers\LegalController::class, 'openSource'])->name('legal.open_source');
Route::get('/commercial-license', [Controllers\LegalController::class, 'commercial'])->name('legal.commercial');

// Cookie 偏好
Route::post('/cookie-consent', [Controllers\CookieConsentController::class, 'store'])->name('cookie_consent.store');
Route::post('/cookie-consent/sync', [Controllers\CookieConsentController::class, 'sync'])->middleware('customer_auth:customer')->name('cookie_consent.sync');
...
Route::post('/checkout/confirm', [Controllers\CheckoutController::class, 'confirm'])
...
Route::prefix('account')
    ...
    ->group(function () {
        ...
        // 隐私与 GDPR
        Route::get('/privacy', [Account\PrivacyController::class, 'index'])->name('privacy.index');
        Route::post('/privacy/consent', [Account\PrivacyController::class, 'consent'])->name('privacy.consent');
        Route::post('/privacy/export', [Account\PrivacyController::class, 'export'])->name('privacy.export');
        Route::post('/privacy/delete', [Account\PrivacyController::class, 'delete'])->name('privacy.delete');
        Route::get('/privacy/download/{id}', [Account\PrivacyController::class, 'download'])->name('privacy.download');
