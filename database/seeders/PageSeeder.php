...
class PageSeeder extends Seeder
{
    ...
    <div class="container">
      <div class="title-box">
        <div class="title">我们的装备系列</div>
        <div class="sub-title">WildPath Gear Collection</div>
      </div>
      <div class="row">
        <div class="col-12 col-md-6">
          <div class="product-item">
            <div class="top">
              ...
              <div class="name">Alpine Storm 帐篷系列</div>
            </div>
            <div class="content">
              旗舰四季防暴雨帐篷，PU5000 防水涂层，双交叉帐杆抗 8 级风。从单人轻量化到家庭露营，覆盖全场景需求。附赠地钉、风绳与应急修补包。
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="product-item">
            <div class="top">
              <div class="left"><i class="bi bi-box-seam-fill"></i></div>
              <div class="name">TrailMaster 背包系列</div>
            </div>
            <div class="content">
              30L 至 80L 多容量登山背包，可调节背负系统，侧袋兼容登山杖。采用 Ripstop 面料与 YKK 拉链，经墨脱、贡嘎等经典线路实地验证。
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="product-item">
            <div class="top">
              ...
              <div class="name">户外小程序</div>
            </div>
            <div class="content">
              微信小程序快速下单，出发前 48 小时加急配送。支持装备清单一键复购、轨迹分享与露营地点收藏，驴友社群互动无缝衔接。
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="product-item">
            <div class="top">
              ...
              <div class="name">WildPath APP</div>
            </div>
            <div class="content">
              移动端 App 提供 AR 帐篷搭建指导、装备重量计算器、离线线路地图与紧急 SOS 功能。会员专享装备评测视频与达人直播带货。
            </div>
          </div>
        </div>
      </div>
        ...
        <div class=\"about-text\">
          ...
          <div class=\"about-text-item\">
            ...
            [
                ...
                'locale'  => 'zh-cn',
                'title'   => '隐私政策',
                'content' => '<p>NiceShoply 非常重视用户的隐私保护。本隐私政策说明了我们如何收集、使用和保护您的个人信息。</p>
...
<p>邮箱：privacy@niceshoply.com</p>',
                'meta_title'       => '隐私政策 - NiceShoply',
                'meta_description' => 'NiceShoply 隐私政策说明',
            ...
            [
                ...
                'content' => '<p>NiceShoply takes your privacy seriously. This Privacy Policy explains how we collect, use, and protect your personal information.</p>
...
<p>Email: privacy@niceshoply.com</p>',
                'meta_title'       => 'Privacy Policy - NiceShoply',
                'meta_description' => 'NiceShoply Privacy Policy',
