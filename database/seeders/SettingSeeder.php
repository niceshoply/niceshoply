...
use NiceShoply\Common\Models\Setting;
...
class SettingSeeder extends Seeder
{
    ...
    private function getSettings(): array
    {
        return [
            ...
            ['space' => 'system', 'name' => 'console_logo', 'value' => 'images/logo-console.svg'],
            ...
            ['space' => 'system', 'name' => 'address', 'value' => '成都市武侯区户外装备产业园 B 座'],
            ['space' => 'system', 'name' => 'telephone', 'value' => '400-886-OUTDOOR'],
            ['space' => 'system', 'name' => 'email', 'value' => 'hello@wildpath-outdoor.demo'],
            ...
            [
                ...
                'name'  => 'meta_title',
                'value' => [
                    'zh-cn' => '野径户外 WildPath - 专业露营徒步装备 | 帐篷睡袋背包一站式选购',
                    'en'    => 'WildPath Outdoor - Professional Camping & Hiking Gear | Tents, Sleeping Bags, Backpacks',
                ],
            ],
            [
                'space' => 'system',
                'name'  => 'meta_keywords',
                'value' => [
                    'zh-cn' => '野径户外,WildPath,露营装备,徒步,帐篷,睡袋,登山背包,户外用品',
                    'en'    => 'WildPath,camping gear,hiking,tent,sleeping bag,backpack,outdoor equipment',
                ],
            ],
            [
                'space' => 'system',
                ...
                'value' => [
                    'zh-cn' => '野径户外 WildPath 专注露营、徒步、攀岩、骑行户外装备。所有商品经过野外实测，提供多仓发货、48 小时加急与专业搭建服务。让每一次出发，都装备齐全、安心可靠。',
                    'en'    => 'WildPath Outdoor specializes in camping, hiking, climbing, and cycling gear. Every product is field-tested. Multi-warehouse shipping, 48-hour express, and professional setup services available.',
                ],
            ],
            [
                'space' => 'system',
